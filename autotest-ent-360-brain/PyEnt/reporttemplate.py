...
class ReportTemplate(object):
    ...
    def get_user_info(self):
        uri = self._console_url + '/__api/system/auth/userInfo'
    ...
    def list(self):
        ...
        uri = self._console_url + '/__api/report/templates'
    ...
    def get(self, id):
        ...
        uri = self._console_url + '/__api/report/template/' + id
    ...
    def create_by_data(self, data):
        ...
        uri = self._console_url + '/__api/report/template'
    ...
    def add_test_template(self, name):
        uri = self._console_url + '/__api/report/template'
        data = {
            "title": name,
            "html": "<p>test</p>",
