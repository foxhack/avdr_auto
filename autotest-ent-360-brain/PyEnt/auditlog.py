...
class AuditLog(object):
    ...
    def query_audit_log(self, start_time=date.today() - timedelta(days=1), end_time=date.today() + timedelta(days=1)):
        ...
        uri = self._console_url + '/__api/system/audit_log/query'
    ...
    def query_update_log(self, start_time=date.today() - timedelta(days=1), end_time=date.today() + timedelta(days=1)):
        ...
        payload = {'paginate': False, 'updateLog': audit_log,'pagination': {}, 'sorts': []}
        uri = self._console_url + '/__api/system/update_log/query'
