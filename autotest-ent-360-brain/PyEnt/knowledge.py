...
class KnowledgeType(object):
    ...
    def list(self):
        ...
        uri = self._console_url + '/__api/security/knowledgeType/query'
    ...
    def get(self, id):
        ...
        uri = self._console_url + '/__api/security/knowledgeType/' + id
    ...
    def create_by_data(self, data):
        ...
        """
        uri = self._console_url + '/__api/security/knowledgeType'
...
class Knowledge(object):
    ...
    def list(self):
        ...
        uri = self._console_url + '/__api/security/knowledge/query'
    ...
    def get(self, id):
        ...
        uri = self._console_url + '/__api/security/knowledge/' + id
    ...
    def create_by_data(self, data):
        ...
        uri = self._console_url + '/__api/security/knowledge'
    ...
    def upload_file(self, local_file):
        ...
        """
        uri = self._console_url + '/__api/security/knowledge/uploadAttachment'
        import os
        multiple_files = [
    ...
    def download_file(self, file_id, local_file):
        ...
        :return: None
        """
        uri = self._console_url + '/__api/security/knowledge/downloadAttachment/' + file_id
        response = self._session.get(uri)
        status_code_check(response.status_code, 200)
