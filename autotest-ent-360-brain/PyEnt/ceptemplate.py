...
class CepTemplate(object):
    ...
    def list(self):
        ...
        uri = self._console_url + '/__api/sae/api/cep/templates'
    ...
    def get(self, id):
        ...
        """
        uri = self._console_url + '/__api/sae/api/cep/templates/' + id
    ...
    def import_tpls(self, localfile):
        ...
        uri = self._console_url + '/__api/sae/api/cep/templates-importexport'
