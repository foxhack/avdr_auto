...
class AssetType(object):
    ...
    def list(self):
        ...
        uri = self._console_url + "/__api/asset/type/query"

        response = self._session.post(uri, headers=header)
        ...
        type_list = [x for x in response_content['data']['list'] if (x['parentId'].strip() or x['parentId'].strip() != '1')]
    ...
    def get(self, id):
        ...
        uri = self._console_url + "/__api/asset/type/" + id
    ...
    def create_by_data(self, data):
        ...
        uri = self._console_url + '/__api/asset/type'
