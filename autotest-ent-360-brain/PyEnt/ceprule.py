...
class CEPRuleType(object):
    ...
    def list(self):
        ...
        uri = self._console_url + "/__api/sae/api/cep/rule-types"
    ...
    def get(self, id):
        ...
        """
        uri = self._console_url + "/__api/sae/api/cep/rule-types/" + id
...
class CepRule(object):
    ...
    def init_event_param(self):
        ...
        """
        uri = self._console_url + "/__api/discover/search/getInitParams"
        response = self._session.get(uri)
        status_code_check(response.status_code, 200)
        response_content = json.loads(response.content)
        response_status_check(response_content['statusCode'], 0, response_content['messages'])
    ...
    def get_event_list(self):
        ...
        """
        uri = self._console_url + "/__api/sae/api/cep/security/eventBase/query"
        response = self._session.get(uri)
        status_code_check(response.status_code, 200)
        response_content = json.loads(response.content)
        response_status_check(response_content['statusCode'], 0, response_content['messages'])
    ...
    def get_alarm_attr_list(self):
        ...
        """
        uri = self._console_url + "/__api/sae/api/cep/alarm/attr/query"
        response = self._session.get(uri)
        status_code_check(response.status_code, 200)
        response_content = json.loads(response.content)
        response_status_check(response_content['statusCode'], 0, response_content['messages'])
    ...
    def list(self):
        ...
        """
        payload = {'paginate': False}
        uri = self._console_url + "/__api/sae/api/cep/rules"
        response = self._session.get(uri, params=payload)
        status_code_check(response.status_code, 200)
        response_content = json.loads(response.content)
        response_status_check(response_content['statusCode'], 0, response_content['messages'])
    ...
    def get(self, id):
        ...
        """
        uri = self._console_url + "/__api/sae/api/cep/rules/" + str(id)
        response = self._session.get(uri)
        status_code_check(response.status_code, 200)
    ...
    def generate_event_dict(self, event_id, event_name, event_type, event_alias='', event_filter=None):
        ...
        if not event_filter:
            ret_dict['filter'] = '{"FilterExpression":{"func":{"left":"event_name","@class":"!=","right":["aaaa"]},"operator":"BASE"}}'
    ...
    def import_rule(self, localfile, strategy='skip'):
        ...
        :return: None
        """
        uri = self._console_url + '/__api/sae/api/cep/import-check'
        ...
        uri = self._console_url + '/__api/sae/api/cep/import-batch'
        if b_dup:
            strategies = {
                'rename': 'rename',
                'skip': 'skip',
    ...
    def export_rule(self, localfile, id_list=[]):
        ...
        :return: None
        """
        uri = self._console_url + '/__api/sae/api/cep/rules-importexport'
        if id_list:
    ...
    def update_cep_ti_info(self, localfile):
        """import cep threat intelligence
        
        :param localfile: ti zip file
        :return: None
        """
        uri = self._console_url + '/__api/sae/api/cep/import/ti'
        with open(localfile, 'rb') as pf:
            content = pf.read()
        response = self._session.post(uri, data=content)
        status_code_check(response.status_code, 200)
