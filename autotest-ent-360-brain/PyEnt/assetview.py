...
class AssetBusiness(object):
    ...
    def list(self):
        ...
        uri = self._console_url + "/__api/asset/business/query"
    ...
    def get(self, id):
        ...
        uri = self._console_url + "/__api/asset/business/" + id
    ...
    def create_by_data(self, data):
        ...
        uri = self._console_url + "/__api/asset/business"
...
class AssetDomain(object):
    ...
    def list(self):
        ...
        payload = {'paginate': False}
        uri = self._console_url + "/__api/asset/domain/query"
    ...
    def get(self, id):
        ...
        uri = self._console_url + "/__api/asset/domain/" + id
        response = self._session.get(uri)
        response_content = json.loads(response.content)
    ...
    def create_by_data(self, data):
        ...
        uri = self._console_url + "/__api/asset/domain"
        response = self._session.post(uri, json=data)
        response_content = json.loads(response.content)
...
class AssetLocation(object):
    ...
    def list(self):
        ...
        payload = {'paginate': False}
        uri = self._console_url + "/__api/asset/location/query"
    ...
    def get(self, id):
        ...
        uri = self._console_url + "/__api/asset/location/" + id
        response = self._session.get(uri)
        response_content = json.loads(response.content)
    ...
    def create_by_data(self, data):
        ...
        uri = self._console_url + "/__api/asset/location"
        response = self._session.post(uri, json=data)
        response_content = json.loads(response.content)
