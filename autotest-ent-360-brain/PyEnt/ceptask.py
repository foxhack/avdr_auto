...
class CepTask(object):
    ...
    def list(self):
        ...
        uri = self._console_url + '/__api/sae/api/cep/tasks'
    ...
    def create(self, name=None, description='', cron_time='', rule_list=[], filter_condition='源地址 != "8.11.1.2"',
               begin_time=date.today() + timedelta(days=-7), end_time=date.today()+ timedelta(days=1), data=None, **kwargs):
        """Create cep task
        ...
        if data:
            ...
            if filter_condition:
                create_data['filter'] = filter_condition
    ...
    def delete(self, id):
        ...
        uri = self._console_url + '/__api/sae/api/cep/tasks/' + str(id)
